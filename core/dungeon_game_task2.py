...
from core import clear_screen, show_help, check_move
...
class BoxGame:
    ...
    def handle_movement(self, movement: str) -> bool:
        ...
        if movement in MOVE:
            ...
            if movement == "up" and self.player_row > 0:
                new_player_row -= 1
            elif movement == "down" and self.player_row < 7:
                new_player_row += 1
            elif movement == "right" and self.player_col < 7:
                new_player_col += 1
            ...
            if (self.player_row, self.player_col) == (self.black_hole_row, self.black_hole_col):
                ...
                self.log_result("SORRY YOU LOSE")
                
                return True
            elif abs(self.player_row - self.dragon_row) <= 2 and abs(self.player_col - self.dragon_col) <= 2:
    ...
    def play_game(self) -> None:
        ...
        while True:
            ...
            try:
                valid_movements = [m for m in [movement] if m in MOVE or m in EXIT_COMMAND or m == "help"]
                if valid_movements:
